...
extern "C"
void Java_netlab_fakturk_anglecalculator_MainActivity_sensorValue(JNIEnv* env, jobject thiz)
{
    ASensorEvent event;
    int events, ident;
...
extern "C"
void Java_netlab_fakturk_anglecalculator_MainActivity_stopSensorPrint(JNIEnv* env, jobject thiz)
{
    sensorPrint=false;
}
extern "C"
void Java_netlab_fakturk_anglecalculator_MainActivity_startSensorPrint(JNIEnv* env, jobject thiz)
{
    sensorPrint=true;
}
